...
func (in *KubeVirtConfiguration) DeepCopyInto(out *KubeVirtConfiguration) {
	*out = *in
	...
	if in.VirtioFSConfiguration != nil {
		in, out := &in.VirtioFSConfiguration, &out.VirtioFSConfiguration
		*out = new(VirtioFSConfiguration)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtioFSConfiguration) DeepCopyInto(out *VirtioFSConfiguration) {
	*out = *in
	if in.CachingPolicy != nil {
		in, out := &in.CachingPolicy, &out.CachingPolicy
		*out = new(VirtioFSCachingPolicy)
		**out = **in
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtioFSConfiguration.
func (in *VirtioFSConfiguration) DeepCopy() *VirtioFSConfiguration {
	if in == nil {
		return nil
	}
	out := new(VirtioFSConfiguration)
